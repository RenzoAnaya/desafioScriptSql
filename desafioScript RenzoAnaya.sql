...
insert into producto (idProduct, nombreProducto, imagenProducto, idCategoria, idEstacionalidad, idPresentacion) values
(1, "Fresa", "fkjdsnfkljsdhflk32497h","1", "2","2"),
(2, "Melón", "fdkjnsf987423nklj","1", "1","1"),
(3, "Camote", "dnmsa9d93whndojkw","2", "1","1"),
(4, "Palta", "dnsaidnas8dnlanm","1", "1","1"),
(5, "Maní", "dñasmd9swdsja9sdn","3", "1","4");
